...
function init() {
    d3.json("https://2u-data-curriculum-team.s3.amazonaws.com/dataviz-classroom/v1.1/14-Interactive-Web-Visualizations/02-Homework/samples.json").then(function (data) {
      console.log(data);
        /// Create array to hold all names
        var names = data.samples.map(x=>x.id)
        /// Append an option in dropdown
    ...
    ///Plot weekly washing frequency in a gauge chart.
    /// Get first ID's washing frequency
    ...
    /// Create path for the gauge needle
        ...
        },
        {
          ...
          marker: {
            colors: [
                ...
                'rgba(54,172,191,0.6)',
                'rgba(80,180,194,0.6)',
                'rgba(107,188,198,0.5)',
                'rgba(134,196,201,0.5)',
                'rgba(160,204,205,0.4)',
                'rgba(187,215,208,0.4)',
                'rgba(213,221,212,0.3)',
                'rgba(240,240,215,0.3)',
                'rgba(225,230,225,0)',
  ...
  function updatePlotly(id) {
    d3.json("https://2u-data-curriculum-team.s3.amazonaws.com/dataviz-classroom/v1.1/14-Interactive-Web-Visualizations/02-Homework/samples.json").then(function (data) {
      console.log(data);
        ...
        /// Get wash frequency for current ID            
